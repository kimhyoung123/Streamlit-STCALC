...
st.write("With this app, you can get simple statistics such as mean, variance and standard deviation. And you can calculate normal distribution values. You can also compute a simple linear regression.")
